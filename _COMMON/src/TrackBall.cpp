...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    if (func != nullptr) _AppDoubleClickFunctionCB = func;
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    if (func != nullptr) _AppMouseButtonFunctionCB = func;
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    if (func != nullptr) _AppMouseMotionFunctionCB = func;
}
...
TrackBall::ETrackballMode TrackBall::evaluateTrackballMode(ETrackballMode new_mode)
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    static ETrackballMode mode = ETrackballMode::TM_ROTATE;

    if (new_mode != ETrackballMode::TM_INVALID)
    {
    ...
    switch(key_modifier)
    {
        case GLUT_ACTIVE_SHIFT:
        {
            if (key_state == GLUT_DOWN)
            {
                ...
                mode = ETrackballMode::TM_TRANSLATEZ;
            }
            else
            {
                // std::cout << "DEBUG: SHIFT UP\n";
                if (mode == ETrackballMode::TM_TRANSLATEZ) mode = ETrackballMode::TM_ROTATE;
            }
            break;
        }
        case GLUT_ACTIVE_CTRL:
        {
            if (key_state == GLUT_DOWN)
            {
                ...
                mode = ETrackballMode::TM_TRANSLATEXY;
            } else {
                // std::cout << "DEBUG: CTRL UP\n";
                if (mode == ETrackballMode::TM_TRANSLATEXY) mode = ETrackballMode::TM_ROTATE;
            }
            break;
        }
        case GLUT_ACTIVE_ALT:
        {
            if (key_state == GLUT_DOWN)
            {
                ...
                mode = ETrackballMode::TM_SCALE;
            }
            else
            {
                // std::cout << "DEBUG: ALT UP\n";
                if (mode == ETrackballMode::TM_SCALE) mode = ETrackballMode::TM_ROTATE;
            }
            break;
        }
        default:
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if (_MouseButtonPressed)
    {
        ...
        if (_AppMouseMotionFunctionCB != nullptr)
        {
    ...
    {
        case ETrackballMode::TM_ROTATE:
        {
            rotateTrackball(dx, dy, _Rotation);
            break;
        }
        case ETrackballMode::TM_SCALE:
        {
        ...
        case ETrackballMode::TM_TRANSLATEXY:
        {
            _Translation[0] += dx / 100.0f;
            _Translation[1] -= dy / 100.0f;
            break;
        }
        case ETrackballMode::TM_TRANSLATEZ:
        {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if (state == GLUT_UP)
    {
        ...
        if (button == GLUT_MIDDLE_BUTTON) evaluateTrackballMode(ETrackballMode::TM_ROTATE);
    }
    else
    {
        ...
        if ((button==GLUT_LEFT_BUTTON) || (button==GLUT_MIDDLE_BUTTON) || (button==GLUT_RIGHT_BUTTON))
        {
            ...
            if (_AppMouseButtonFunctionCB != nullptr)
            {
                _AppMouseButtonFunctionCB(x, y, x, y);
            }

            if (button == GLUT_MIDDLE_BUTTON) evaluateTrackballMode(ETrackballMode::TM_TRANSLATEZ);
            ...
            if ( ((dblclick_finish - dblclick_start) < dblclick_diff) && (_AppDoubleClickFunctionCB != nullptr) )
            {
